...
from edmsci.utils.random_walks import RandomWalkSampler
import pickle
...
class TripletDataset(Dataset):
    ...
    def _generate_samples(self):
        ...
        walks = self.rw_sampler.sampling(
            self.node_order[self.scanned_node_id : int(next_scanned_node_id)]
        )
        ...
        self.scanned_node_id = int(next_scanned_node_id % self.n_nodes)
        self.sample_id = 0
